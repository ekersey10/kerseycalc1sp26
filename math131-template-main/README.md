# MATH 131 Template Course

These are course materials for MATH 131, Calculus I, as taught at the University of Northern Colorado.  So far these consist of the materials created by Oscar Levin and Sarah Sparks during Fall 2025, but we expect they will be modified and expanded each semester as new instructors teach the course and make improvements.

## Repository Contents

Most of the course materials are PreTeXt files contained in the `source` folder.  Quizzes are LaTeX files in the `quizzes` folder.  Additional course files are in the `docs` folder.

After each semester, we encourage instructors to update this template by moving new materials they have created or modified to this repository, committing it, and including a short summary of the changes in the docs folder (including advice to future instructors, describing what went well and what could be improved).
